...
- **The plan to execute:** `docs/superpowers/plans/2026-06-02-phase-B-cross-workspace-execution.md` — 8 tasks, threat model **B1–B10** inline, **four pre-dispatch review fixes already baked in** (see "Fixes baked in"). Build-ready.
