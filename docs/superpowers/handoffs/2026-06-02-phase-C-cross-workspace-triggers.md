...
- **The plan to execute:** `docs/superpowers/plans/2026-06-02-phase-C-cross-workspace-triggers.md` — 6 tasks (1, 2, 3, 3.5, 4, 5), threat model **C1–C6** inline, **four pre-dispatch review fixes already baked in** (see "Fixes baked in"). Build-ready.
