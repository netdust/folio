import { type CronShapeResult, KNOWN_EVENT_KINDS, validateCronShape } from '@folio/shared';
import { z } from 'zod';
...
export const triggerFrontmatterSchema = z
  .object({
    ...
    agent: z.union([z.string().min(1), z.null()]).optional(),
    schedule: cronOrNull,
  ...
  .strict()
  .refine((d) => d.schedule !== null || d.on_event !== null, {
