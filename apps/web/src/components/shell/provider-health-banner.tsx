  ...
  return (
    ...
    >
      ...
      <Button
        ...
        size="sm"
        onClick={() =>
          // AI keys live on the instance settings page (instance-wide store).
          // Use the in-workspace route so the rail stays mounted — same chrome
          // as opening Settings from the user menu.
          void navigate({
