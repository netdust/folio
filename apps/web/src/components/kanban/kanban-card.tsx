...
function CardBody({
  ...
  return (
    ...
    >
      {/* The drop-indicator line is rendered by KanbanColumn as a flex sibling
          between cards (NOT here) — inside the card it inherited the card's
          sortable transform and "followed the moving card". */}
