...
- **Phase 1.6.1 (Rail siblings under project):** NEXT — half-day polish. Wiki as a rail leaf + `+ New table` trailing on project rows, so the table layer stops looking like dead weight when there's only one table. See `docs/PHASES.md` §1.6.1.
